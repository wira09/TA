                ...
                <form action="{{ route('admin.tracer.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="mulai_kerja" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Mulai
                            Kerja</label>
                        <input type="date" name="mulai_kerja" id="mulai_kerja" value="{{ old('mulai_kerja') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <select name="kesesuaian_kerja" id="kesesuaian_kerja"
                            ...
                            <option value="Sangat Sesuai"
                                {{ old('kesesuaian_kerja') == 'Sangat Sesuai' ? 'selected' : '' }}>Sangat Sesuai</option>
                            <option value="Sesuai" {{ old('kesesuaian_kerja') == 'Sesuai' ? 'selected' : '' }}>Sesuai
                            </option>
                            <option value="Kurang Sesuai"
                                {{ old('kesesuaian_kerja') == 'Kurang Sesuai' ? 'selected' : '' }}>Kurang Sesuai</option>
                            <option value="Tidak Sesuai" {{ old('kesesuaian_kerja') == 'Tidak Sesuai' ? 'selected' : '' }}>
                                Tidak Sesuai</option>
                        </select>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="date" name="tgl_update" id="tgl_update" value="{{ old('tgl_update') }}"
